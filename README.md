...
- 100+ сайтов с битриксом на 10 VPS под Docker. Да, сайты на битриксе работают на нашем собственном стеке MSQL+NGINX+APACHE. Каждяй сайт изолирован друг от друга отдельным контейнером со своим апачем.
